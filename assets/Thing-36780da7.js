import{q as c,n as o,J as m,v as a,p as I,u as B,j as _,x as $,N as z,A as u,cL as O,M as T,Q as L,z as y,D as w,k as t,m as M,y as H,X as V,cM as F,a5 as K}from"./index-31d2750e.js";const q=c([o("list",`
...
`,[o("thing-avatar",`
 ...
 margin-top: 12px;
 `)])])]),N=Object.assign(Object.assign({},u.props),{title:String,titleExtra:String,description:String,descriptionStyle:[String,Object],content:String,contentStyle:[String,Object],contentIndented:Boolean}),G=_({name:"Thing",props:N,setup(r,{slots:e}){const{mergedClsPrefixRef:n,inlineThemeDisabled:s,mergedRtlRef:f}=$(r),b=u("Thing","-thing",J,F,r,n),v=z("Thing",f,n),l=y(()=>{const{self:{titleTextColor:h,textColor:i,titleFontWeight:g,fontSize:x},common:{cubicBezierEaseInOut:p}}=b.value;return{"--n-bezier":p,"--n-font-size":x,"--n-text-color":i,"--n-title-font-weight":g,"--n-title-text-color":h}}),d=s?w("thing",void 0,l,r):void 0;return()=>{var h;const{value:i}=n,g=v?v.value:!1;return(h=d==null?void 0:d.onRender)===null||h===void 0||h.call(d),t("div",{class:[`${i}-thing`,d==null?void 0:d.themeClass,g&&`${i}-thing--rtl`],style:s?void 0:l.value},e.avatar&&r.contentIndented?t("div",{class:`${i}-thing-avatar`},e.avatar()):null,t("div",{class:`${i}-thing-main`},!r.contentIndented&&(e.header||r.title||e["header-extra"]||r.titleExtra||e.avatar)?t("div",{class:`${i}-thing-avatar-header-wrapper`},e.avatar?t("div",{class:`${i}-thing-avatar`},e.avatar()):null,e.header||r.title||e["header-extra"]||r.titleExtra?t("div",{class:`${i}-thing-header-wrapper`},t("div",{class:`${i}-thing-header`},e.header||r.title?t("div",{class:`${i}-thing-header__title`},e.header?e.header():r.title):null,e["header-extra"]||r.titleExtra?t("div",{class:`${i}-thing-header__extra`},e["header-extra"]?e["header-extra"]():r.titleExtra):null),e.description||r.description?t("div",{class:`${i}-thing-main__description`,style:r.descriptionStyle},e.description?e.description():r.description):null):null):t(K,null,e.header||r.title||e["header-extra"]||r.titleExtra?t("div",{class:`${i}-thing-header`},e.header||r.title?t("div",{class:`${i}-thing-header__title`},e.header?e.header():r.title):null,e["header-extra"]||r.titleExtra?t("div",{class:`${i}-thing-header__extra`},e["header-extra"]?e["header-extra"]():r.titleExtra):null):null,e.description||r.description?t("div",{class:`${i}-thing-main__description`,style:r.descriptionStyle},e.description?e.description():r.description):null),e.default||r.content?t("div",{class:`${i}-thing-main__content`,style:r.contentStyle},e.default?e.default():r.content):null,e.footer?t("div",{class:`${i}-thing-main__footer`},e.footer()):null,e.action?t("div",{class:`${i}-thing-main__action`},e.action()):null))}}});export{G as _,X as a,W as b};
